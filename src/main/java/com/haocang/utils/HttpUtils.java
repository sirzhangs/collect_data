...
public class HttpUtils {
     ...
     * post请求,params表示参数,headers表示请求头
     */
    public static String postForJSON(String url, String params, Map<String, String>... headers) {
        String html = "";
        HttpPost httpPost = null;
        try {
            // 参数设置
        ...
        public String handleResponse(HttpResponse response) throws ClientProtocolException, IOException {
            ...
            try {
                ...
                switch (statusCode) {
                    ...
                    case 400:
                        System.out.println("下载400错误代码，请求出现语法错误.");
                        break;
                    case 403:
                        System.out.println("下载403错误代码，资源不可用.");
                        break;
                    case 404:
                        System.out.println("下载404错误代码，无法找到指定资源地址.");
                        break;
                    case 503:
                        System.out.println("下载503错误代码，服务不可用.");
                        break;
                    case 504:
                        System.out.println("下载504错误代码，网关超时.");
                        break;
                    default:
                        System.out.println("未处理的错误,code=" + statusCode);
                }
            } finally {
                if (response != null) {
                    try {
